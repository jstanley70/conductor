...
public class TestCcctcHttpTask {
    ...
    public void testPost() throws Exception {
        ...
        input.setUri("http://localhost:7010/post");
    ...
    public void testPostNoContent() throws Exception {
        ...
        Task task = new Task();
        Input input = new Input();
        input.setUri("http://localhost:7010/post2");
        Map<String, Object> body = new HashMap<>();
        body.put("input_key1", "value1");
        body.put("input_key2", 45.3d);
        input.setBody(body);
    ...
    public void testFailure() throws Exception {
        ...
        Task task = new Task();
        Input input = new Input();
        input.setUri("http://localhost:7010/failure");
        input.setMethod("GET");
        task.getInputData().put(HttpTask.REQUEST_PARAMETER_NAME, input);
    ...
    public void testTextGET() throws Exception {
        ...
        Task task = new Task();
        Input input = new Input();
        input.setUri("http://localhost:7010/text");
        input.setMethod("GET");
        task.getInputData().put(HttpTask.REQUEST_PARAMETER_NAME, input);
    ...
    public void testNumberGET() throws Exception {
        ...
        Task task = new Task();
        Input input = new Input();
        input.setUri("http://localhost:7010/numeric");
        input.setMethod("GET");
        task.getInputData().put(HttpTask.REQUEST_PARAMETER_NAME, input);
    ...
    public void testJsonGET() throws Exception {
        ...
        Task task = new Task();
        Input input = new Input();
        input.setUri("http://localhost:7010/json");
        input.setMethod("GET");
        task.getInputData().put(HttpTask.REQUEST_PARAMETER_NAME, input);
    ...
    public void testOAuth() throws Exception {
        Task task = new Task();
        Input input = new Input();
        input.setUri("http://localhost:7010/oauth");
        input.setMethod("POST");
